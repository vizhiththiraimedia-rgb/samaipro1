...
define('SERVICE_NAME', 'Samakuru');
define('SERVICE_SLUG', 'sam-superapp');
define('SERVICE_KEY', 'sk-samai-ea9ca746c4544895-7745d5df18c84c4e');
...
// Site Info
define('SITE_TITLE', 'Samakuru');
define('SITE_TAGLINE', 'Samakuru - The Ultimate Super App for Sri Lanka with News, Typing, and Voice tools');
...
define('CREDIT_COST_PRIMARY', 1);

$SAMAI_PRIMARY_ENDPOINT = 'translate_type';
$SAMAI_ENDPOINTS = [
    'translate_type' => [
        'path' => '/superapp/type',
        'params' => [
            'text' => ['type' => 'text', 'label' => 'Text to Translate/Type'],
            'lang' => ['type' => 'select', 'label' => 'Language', 'options' => ['si' => 'Sinhala', 'ta' => 'Tamil', 'en' => 'English']]
        ]
    ]
];
