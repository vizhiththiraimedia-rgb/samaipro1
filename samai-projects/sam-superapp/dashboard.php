...
if (!function_exists('getEndpointField')) {
    function getEndpointField($name, $def) {
        $type = $def['type'] ?? 'text';
        $placeholder = $def['placeholder'] ?? '';
        $required = ($def['required'] ?? false) ? 'required' : '';
        
        if ($type === 'select' && isset($def['options'])) {
            $html = "<select name=\"$name\" id=\"$name\" style=\"width: 100%; padding: 12px; border: 1px solid #4b5563; border-radius: 8px; background: #111827; color: #fff; font-size: 14px; margin-bottom: 15px;\" $required>";
            ...
            return "<textarea name=\"$name\" id=\"$name\" rows=\"4\" placeholder=\"$placeholder\" style=\"width: 100%; padding: 12px; border: 1px solid #4b5563; border-radius: 8px; background: #111827; color: #fff; font-size: 14px; margin-bottom: 15px;\" $required></textarea>";
        } else {
            return "<input type=\"$type\" name=\"$name\" id=\"$name\" placeholder=\"$placeholder\" style=\"width: 100%; padding: 12px; border: 1px solid #4b5563; border-radius: 8px; background: #111827; color: #fff; font-size: 14px; margin-bottom: 15px;\" $required>";
        }
    }
}
