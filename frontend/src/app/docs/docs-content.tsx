...
const LIVE_DOMAIN = "https://samaipro1-production.up.railway.app";
      ...
      <main style={{ flex: 1, padding: "2.5rem 3rem", maxWidth: "900px", overflowY: "auto" }}>
        ...
        {activeSection === "overview" && (
          <div className="animate-fade-in">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
              {[
                { label: "Live Domain", value: "samaipro1-production.up.railway.app", color: "#22c55e" },
            ...
            <div style={{ background: "rgba(34,197,94,0.08)", border: "1px solid rgba(34,197,94,0.3)", borderRadius: "10px", padding: "1rem 1.2rem" }}>
              ...
              <div style={{ marginTop: "0.3rem", fontFamily: "monospace", fontSize: "1rem", color: "#e6edf3" }}>
                https://samaipro1-production.up.railway.app
              </div>
            </div>
          </div>
        )}
        ...
        {activeSection === "base-url" && (
          <div className="animate-fade-in">
            ...
            <CodeBlock code={`Base URL:\nhttps://samaipro1-production.up.railway.app\n\nAPI Routes:\nhttps://samaipro1-production.up.railway.app/api/<endpoint>\n\nExamples:\nhttps://samaipro1-production.up.railway.app/api/crypto/market\nhttps://samaipro1-production.up.railway.app/api/chat/default\nhttps://samaipro1-production.up.railway.app/api/lead-gen/search`} id="baseurl" />
        ...
        {activeSection === "endpoints" && (
          <div className="animate-fade-in">
            ...
            <p style={{ color: "var(--text-muted)", marginBottom: "1.5rem" }}>All endpoints are live on <strong style={{ color: "#22c55e" }}>https://samaipro1-production.up.railway.app</strong></p>
            ...
            <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: "14px", padding: "1.5rem", marginBottom: "1.5rem" }}>
              <div style={{ display: "flex", gap: "0.8rem", marginBottom: "1rem", flexWrap: "wrap" }}>
                ...
                <div style={{ flex: 1, display: "flex", alignItems: "center", background: "rgba(0,0,0,0.3)", border: "1px solid var(--border)", borderRadius: "8px", paddingLeft: "0.8rem", fontSize: "0.85rem", color: "var(--text-muted)", minWidth: "200px" }}>
                  <span style={{ color: "#22c55e", marginRight: "0.4rem", fontFamily: "monospace" }}>samaipro1-production.up.railway.app</span>
                  <input
                    type="text"
                    value={tryItPath}
